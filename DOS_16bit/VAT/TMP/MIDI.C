...
BYTE          midi_instrument[128][11]= {
	{0x30,0x30,0x40,0x00,0xE1,0xE2,0xDD,0xD3,0x00,0x01,0x00},//ACGPIANO
	{0x30,0x31,0x40,0x00,0xE1,0xE3,0xDD,0xD3,0x00,0x01,0x00},//ACPiano
	{0x30,0x30,0x40,0x00,0xE1,0xE2,0xDD,0xD3,0x04,0x01,0x00},//ELGPIANO
	{0x31,0x30,0x40,0x00,0xE1,0xE2,0xDD,0xD3,0x04,0x01,0x00},//HONKTONK
	{0x30,0x30,0x40,0x00,0xE1,0xE2,0x87,0x63,0x06,0x01,0x00},//ELPIANO1
	{0x30,0x33,0x40,0x00,0xE1,0xE2,0x87,0x63,0x06,0x01,0x00},//ElPiano2
	{0x03,0x01,0x00,0x00,0xF3,0xE4,0x64,0x35,0x00,0x01,0x00},//HARPSCHD
	{0x01,0x11,0x49,0x02,0xF1,0xF1,0x53,0x74,0x06,0x01,0x02},//CLAVICHD
	{0x16,0x11,0x4F,0x0A,0xF2,0xF2,0x61,0x74,0x08,0x00,0x00},//CELESTA
	{0x34,0x36,0x00,0x00,0xB3,0xD3,0xC3,0xB3,0x02,0x01,0x00},//GLOCK
	{0x35,0x35,0x00,0x00,0xF3,0xF3,0xC3,0xB3,0x01,0x01,0x00},//MUSICBOX
	{0xB1,0xB1,0x00,0x00,0xA3,0xB3,0xC3,0xB3,0x01,0x01,0x00},//VIBES
	{0x85,0x81,0x4D,0x80,0xDA,0xF9,0x16,0x05,0x0A,0x00,0x00},//MARIMBA
	{0x05,0xC4,0x05,0x00,0xFE,0xF8,0x65,0x85,0x0E,0x00,0x00},//XYLOPHON
	{0x13,0x01,0x4F,0x10,0xF2,0xF2,0x60,0x72,0x08,0x00,0x00},//TUBEBELL
	{0x03,0x17,0x4F,0x0B,0xF1,0xF2,0x53,0x74,0x06,0x00,0x00},//Dulcimer
	{0x64,0x21,0x86,0x80,0xFF,0xFF,0x0F,0x0F,0x01,0x00,0x00},//DrawOrgn
	{0x24,0x21,0x80,0x80,0xFF,0xFF,0x0F,0x0F,0x01,0x00,0x00},//PRCORGAN
	{0x72,0x71,0x00,0x00,0x80,0x80,0xC3,0xB3,0x01,0x01,0x00},//ROCKORGN
	{0xB2,0xB0,0x43,0x00,0x9F,0x95,0x06,0x0F,0x09,0x04,0x01},//PIPEORGN
	{0x01,0x33,0x4F,0x05,0xF0,0x90,0xFF,0x0F,0x06,0x00,0x00},//REEDORGN
	{0x24,0x31,0x4F,0x10,0xF2,0x52,0x0B,0x0B,0x04,0x01,0x00},//ACCORDN
	{0x21,0xA2,0x15,0x80,0x61,0x62,0x03,0x67,0x04,0x00,0x00},//HARMNICA
	{0xE1,0xE1,0xD0,0x00,0xF5,0xF4,0xAF,0x0F,0x0C,0x00,0x01},//TANGOAcc
	{0x01,0x01,0x00,0x00,0xD8,0xD8,0x96,0x96,0x0A,0x00,0x00},//MELDYDRM
	{0x06,0x00,0x00,0x00,0xF0,0xF6,0xF0,0xB4,0x0E,0x00,0x00},//SYNTHDRM
	{0x01,0x01,0x80,0x80,0x5F,0x5F,0x0B,0x0B,0x04,0x01,0x01},//REVCYMB
	{0x51,0x42,0x00,0x05,0x66,0x66,0x05,0x06,0x00,0x02,0x00},//FRET
	{0x53,0x00,0x05,0x00,0x5F,0x7F,0x66,0x07,0x06,0x00,0x00},//BREATH
	{0x0E,0x0E,0x00,0x00,0x20,0x21,0x00,0x01,0x0E,0x00,0x00},//SEASHORE
	{0xC0,0x7E,0x4F,0x0C,0xF1,0x10,0x03,0x01,0x02,0x00,0x00},//TWEET
	{0xF4,0xF3,0x50,0x80,0x85,0x74,0x87,0x99,0x0C,0x00,0x00},//RING
	{0xF0,0xE2,0x00,0xC0,0x1E,0x11,0x11,0x11,0x08,0x01,0x01},//HELICPTR
	{0x7E,0x6E,0x00,0x00,0xFF,0x3F,0x0F,0x0F,0x0E,0x00,0x00},//APPLAUD
...
/*						else {                     // There might be space later
		...
		midi_timer[i]-= midi_tempoadjust;   // decrement timer.
																				// The frequency of the sound blaster
																				// interrupt determines the lower
																				// bounds for the Midi Tempo.
																				// If this lower bound gets to
																				// big, you can lower
																				// midi_tempoadjust to compensate.
	}
...
/*	while(vhold) {
		...
		for(i = 0; i < 9; i++) {            // loop through FM voices
			if(!midi_voice[i].active) {                // found empty one? set the note!
				midi_voice[i].owner_track = vh[vhold].owner_track;
				midi_voice[i].owner_channel = vh[vhold].owner_channel;
				midi_voice[i].note = vh[vhold].note;
				midi_voice[i].volume = vh[vhold].volume;
				midi_voice[i].active = TRUE;
				FMSetNote(i,b1);
				FMSetVolume(i,midi_volume);
				FMKeyOn(i);
				break;
			}
		}
...
SHORT MPUEnter(void)
{
  ...
  while(flag) {
	  ...
	  for(mpu_timeout = 0; mpu_timeout < TIMEOUT; mpu_timeout++) {
		  if(!(inportb(midi_mpuport+1) & 0x40)) break;
	  }
	  dbprintf("MPUENTER() - check ready t.o.: %u\n",mpu_timeout);
    mpu_timeout =0;                         // reset timeout.

	  outportb(midi_mpuport+1,0xFF);          // Send reset command

	  while(mpu_timeout<TIMEOUT) {            // Wait for ready bit to clear
		  mpu_timeout++;
		  if(!(inportb(midi_mpuport+1)&0x80)) break;
	  }

	  dbprintf("MPUENTER() - wait ready clear t.o.: %u\n",mpu_timeout);
		mpu_timeout = 0;

    ack = inportb(midi_mpuport);                     // Read the ACK byte
    flag --;
  ...
  outportb(midi_mpuport+1,0x3F);          // Put it in UART mode
...
void MPUExit(void)
{
  ...
  vdisable();
	outportb(midi_mpuport+1,0xFF);          // Reset the MPU
  venable();
}
...
void MPUWrite(BYTE b)
{
	...
	outportb(midi_mpuport,b);           // Write the byte!
}
